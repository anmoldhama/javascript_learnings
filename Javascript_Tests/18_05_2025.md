...
ans : shallow copy only copey the references of the nested propertis
...
ans : setTimeout is accepting the callback and a timer the callback is executed after the timer ends
...
ans : the generator function is used to create a private variable
...
ans : Javascript uses two different module patterns like
      ...
      ES modules in which the import/exports works asynchronouly
                In which we use import to import anuthing and default,named exports to export
